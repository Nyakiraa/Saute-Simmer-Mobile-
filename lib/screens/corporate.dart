...
Description: This page is only exclusive to only for corporate servations.
 */

class CorporateRegistrationScreen extends StatefulWidget {
  final Map<String, String> corporateInfo;
  ...
  @override
  State<CorporateRegistrationScreen> createState() => _CorporateRegistrationScreenState();
}

class _CorporateRegistrationScreenState extends State<CorporateRegistrationScreen> {
  ...
  void initState() {
    ...
    final nameParts = widget.corporateInfo['name']?.split(' ') ?? ['', ''];
    ...
    _streetAddressController = TextEditingController(text: widget.corporateInfo['address'] ?? '');
    _cityController = TextEditingController(text: widget.corporateInfo['city'] ?? '');
    _provinceController = TextEditingController(text: widget.corporateInfo['province'] ?? '');
    _phoneController = TextEditingController(text: widget.corporateInfo['phone'] ?? '+63');
    _peopleController = TextEditingController(text: widget.corporateInfo['people'] ?? '');
    _dateController = TextEditingController(text: widget.corporateInfo['date'] ?? '');
    _timeController = TextEditingController(text: widget.corporateInfo['time'] ?? '');
    _specialRequestController = TextEditingController(text: widget.corporateInfo['specialRequest'] ?? '');
  }
